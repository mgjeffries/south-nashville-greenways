...
const post: BlogPost = {
  ...
  content: [
    { type: 'image', src: '/images/blog/east-thompson/design-concept.png', alt: 'Design concept for East Thompson Lane bikeways', isHeroImage: true, includeOnCoverCard: true, caption: 'NDOT design concept for East Thompson Lane' },
    ...
    { type: 'image', src: '/images/blog/east-thompson/intersection.png', alt: 'Map showing traffic accidents at the Thompson and East Thompson intersection', includeOnCoverCard: true, caption: 'Traffic accident data at the Thompson and East Thompson intersection. Source: Nashville Open Data' },
