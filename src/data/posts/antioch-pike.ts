...
const post: BlogPost = {
  ...
  content: [
    { type: 'image', src: '/images/blog/antioch-pike/mural.jpg', alt: 'A vibrant painted mural path along Antioch Pike featuring colorful floral designs', isHeroImage: true, includeOnCoverCard: true, caption: 'Painted mural bikeway along Antioch Pike' },
    ...
    { type: 'image', src: '/images/blog/antioch-pike/project-extents.png', alt: 'Map showing the Antioch Pike project extents', includeOnCoverCard: true, caption: 'Map of current bikeway' },
    ...
    },
    {
      ...
      left: { src: '/images/blog/antioch-pike/large-buffers-concept.png', alt: 'Design concept with wide buffers between the bike lane and traffic' },
      right: { src: '/images/blog/antioch-pike/center-median-concept.png', alt: 'Design concept with a center median' },
      caption: 'Comparison of two proposed plans',
    },
  ],
  links: [
    {
