...
const post: BlogPost = {
  ...
  content: [
    ...
    "Replacing the turn lane with a pedestrian refuge, adding more crosswalks, and reducing turn radii as shown could improve the safety of this intersection.",
