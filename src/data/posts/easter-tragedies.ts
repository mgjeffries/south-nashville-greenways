...
const post: BlogPost = {
  ...
  content: [
    ...
    { type: "heading", level: 3, text: "Design Concept" },
    { type: "image", src: "/images/blog/2026-easter-tragedies/pedestrian-refuge.png", alt: "Design concept including a pedestrian refuge", caption: "Design concept by the Civic Design Center including additional crosswalks and a pedestrian refuge", sourceUrl: "https://platform.remix.com/project/b69da617/scenario/e0cf37a9-66a2-4fe0-a686-ed0974aa655e?latlng=36.14734,-86.75808,18.817,p0,b22.4"},
    "Replacing the turn lane with a pedestrian refuge, adding more crosswalks, and reducing turn radii as shown could improve the safety of this intersection. This design is interactive, so if you have an idea, leave a comment for the Civic Design Center on the live site!",
