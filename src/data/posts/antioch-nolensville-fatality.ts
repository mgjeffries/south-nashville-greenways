...
const post: BlogPost = {
  ...
  content: [
    ...
    { type: "image", src: "/images/blog/antioch-nolensville-fatality/patch.png", alt: "A patch has replaced the leading edge of the painted median on Antioch Pike", caption: "Patch covers painted median" },
    { type: "image", src: "/images/blog/antioch-nolensville-fatality/median.png", alt: "The painted median on Antioch Pike is missing in sections", caption: "Still no sign of the median" },
    ...
    { type: "image", src: "/images/blog/antioch-nolensville-fatality/2026-03-14-repaving.JPG", alt: "Repaving work at the Antioch Pike and Nolensville Pike intersection", caption: "Repaving work at the intersection on March 14th" },
    ...
    { type: "image", src: "/images/blog/antioch-nolensville-fatality/03-25-missing-crosswalks-and-median.JPG", alt: "Crosswalks and median are still missing after repaving", caption: "The crosswalks and median are still missing after repaving" },
