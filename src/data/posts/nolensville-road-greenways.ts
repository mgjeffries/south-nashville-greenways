...
const post: BlogPost = {
  ...
  content: [
    ...
    "Let's get back to the part where I said that a greenway on this section of road is closer than you think! Here's what I mean by that: although Nolensville Pike itself is dangerous for walking and biking, The alley on the west side is actually very protected. It passes by a coffee shop, bakery, restaurants, churches, the drug store and donut shop! Although it's not currently set up as a walking path, it could easily become one with a little bit of care. If the community and city work together we could de-pave some of the asphalt to create green space. Having a mixed use path with greenspace would encourage patrons to park a little further from their destination and enjoy a short walk.",
    { type: 'image-comparison', left:{ src: '/images/blog/nolensville-road-greenways/alley-before.png', alt: 'Current state of the alley on the west side of Nolensville Pike' }, right: { src: '/images/blog/nolensville-road-greenways/conceptual-rendering-with-park.png', alt: 'Conceptual rendering of a greenway with park space along the west side alley of Nolensville Pike' } },
